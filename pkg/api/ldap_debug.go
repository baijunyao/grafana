...
func (hs *HTTPServer) ReloadLDAPCfg() utils.Response {
	if !ldap.IsEnabled() {
...
func (hs *HTTPServer) GetLDAPStatus(c *models.ReqContext) utils.Response {
	if !ldap.IsEnabled() {
		return utils.Error(http.StatusBadRequest, "LDAP is not enabled", nil)
	}
...
func (hs *HTTPServer) PostSyncUserWithLDAP(c *models.ReqContext) utils.Response {
	if !ldap.IsEnabled() {
		return utils.Error(http.StatusBadRequest, "LDAP is not enabled", nil)
	}
...
func (hs *HTTPServer) GetUserFromLDAP(c *models.ReqContext) utils.Response {
	if !ldap.IsEnabled() {
		return utils.Error(http.StatusBadRequest, "LDAP is not enabled", nil)
	}
