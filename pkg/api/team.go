...
// POST /api/teams
func (hs *HTTPServer) CreateTeam(c *models.ReqContext, cmd models.CreateTeamCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func (hs *HTTPServer) UpdateTeam(c *models.ReqContext, cmd models.UpdateTeamCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func (hs *HTTPServer) DeleteTeamByID(c *models.ReqContext) utils.Response {
	orgId := c.OrgId
...
func (hs *HTTPServer) SearchTeams(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) GetTeamByID(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) GetTeamPreferences(c *models.ReqContext) utils.Response {
	teamId := c.ParamsInt64(":teamId")
	orgId := c.OrgId
...
func (hs *HTTPServer) UpdateTeamPreferences(c *models.ReqContext, dtoCmd dtos.UpdatePrefsCmd) utils.Response {
	teamId := c.ParamsInt64(":teamId")
	orgId := c.OrgId
