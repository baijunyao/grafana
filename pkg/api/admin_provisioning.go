...
func (hs *HTTPServer) AdminProvisioningReloadDashboards(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) AdminProvisioningReloadDatasources(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) AdminProvisioningReloadPlugins(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) AdminProvisioningReloadNotifications(c *models.ReqContext) utils.Response {
