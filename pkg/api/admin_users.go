...
func AdminCreateUser(c *models.ReqContext, form dtos.AdminCreateUserForm) utils.Response {
...
func AdminUpdateUserPassword(c *models.ReqContext, form dtos.AdminUpdateUserPasswordForm) utils.Response {
...
func AdminUpdateUserPermissions(c *models.ReqContext, form dtos.AdminUpdateUserPermissionsForm) utils.Response {
	userID := c.ParamsInt64(":id")
...
func AdminDeleteUser(c *models.ReqContext) utils.Response {
	userID := c.ParamsInt64(":id")
...
func (hs *HTTPServer) AdminDisableUser(c *models.ReqContext) utils.Response {
	userID := c.ParamsInt64(":id")
...
func AdminEnableUser(c *models.ReqContext) utils.Response {
	userID := c.ParamsInt64(":id")
...
func (hs *HTTPServer) AdminLogoutUser(c *models.ReqContext) utils.Response {
	userID := c.ParamsInt64(":id")
...
func (hs *HTTPServer) AdminGetUserAuthTokens(c *models.ReqContext) utils.Response {
	userID := c.ParamsInt64(":id")
	return hs.getUserAuthTokensInternal(c, userID)
}

// POST /api/admin/users/:id/revoke-auth-token
func (hs *HTTPServer) AdminRevokeUserAuthToken(c *models.ReqContext, cmd models.RevokeAuthTokenCmd) utils.Response {
	userID := c.ParamsInt64(":id")
