...
func SendResetPasswordEmail(c *models.ReqContext, form dtos.SendResetPasswordEmailForm) utils.Response {
...
func ResetPassword(c *models.ReqContext, form dtos.ResetUserPasswordForm) utils.Response {
