...
func GetSignUpOptions(c *models.ReqContext) utils.Response {
...
func SignUp(c *models.ReqContext, form dtos.SignUpForm) utils.Response {
...
func (hs *HTTPServer) SignUpStep2(c *models.ReqContext, form dtos.SignUpStep2Form) utils.Response {
	if !setting.AllowUserSignUp {
		return utils.Error(401, "User signup is disabled", nil)
	}
...
func verifyUserSignUpEmail(email string, code string) (bool, utils.Response) {
