...
func SetHomeDashboard(c *models.ReqContext, cmd models.SavePreferencesCommand) utils.Response {
	cmd.UserId = c.UserId
	cmd.OrgId = c.OrgId
...
func GetUserPreferences(c *models.ReqContext) utils.Response {
	return getPreferencesFor(c.OrgId, c.UserId, 0)
}

func getPreferencesFor(orgID, userID, teamID int64) utils.Response {
...
func UpdateUserPreferences(c *models.ReqContext, dtoCmd dtos.UpdatePrefsCmd) utils.Response {
	return updatePreferencesFor(c.OrgId, c.UserId, 0, &dtoCmd)
}

func updatePreferencesFor(orgID, userID, teamId int64, dtoCmd *dtos.UpdatePrefsCmd) utils.Response {
...
func GetOrgPreferences(c *models.ReqContext) utils.Response {
	return getPreferencesFor(c.OrgId, 0, 0)
}

// PUT /api/org/preferences
func UpdateOrgPreferences(c *models.ReqContext, dtoCmd dtos.UpdatePrefsCmd) utils.Response {
