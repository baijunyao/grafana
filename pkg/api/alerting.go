...
func GetAlertStatesForDashboard(c *models.ReqContext) utils.Response {
...
// GET /api/alerts
func GetAlerts(c *models.ReqContext) utils.Response {
...
func AlertTest(c *models.ReqContext, dto dtos.AlertTestCommand) utils.Response {
...
// GET /api/alerts/:id
func GetAlert(c *models.ReqContext) utils.Response {
	id := c.ParamsInt64(":alertId")
	query := models.GetAlertByIdQuery{Id: id}
...
func GetAlertNotifiers(c *models.ReqContext) utils.Response {
	return utils.JSON(200, alerting.GetNotifiers())
}

func GetAlertNotificationLookup(c *models.ReqContext) utils.Response {
...
func GetAlertNotifications(c *models.ReqContext) utils.Response {
	alertNotifications, err := getAlertNotificationsInternal(c)
	if err != nil {
		return utils.Error(500, "Failed to get alert notifications", err)
	}
...
func GetAlertNotificationByID(c *models.ReqContext) utils.Response {
...
func GetAlertNotificationByUID(c *models.ReqContext) utils.Response {
...
func CreateAlertNotification(c *models.ReqContext, cmd models.CreateAlertNotificationCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func UpdateAlertNotification(c *models.ReqContext, cmd models.UpdateAlertNotificationCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func UpdateAlertNotificationByUID(c *models.ReqContext, cmd models.UpdateAlertNotificationWithUidCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func DeleteAlertNotification(c *models.ReqContext) utils.Response {
...
func DeleteAlertNotificationByUID(c *models.ReqContext) utils.Response {
...
func NotificationTest(c *models.ReqContext, dto dtos.NotificationTestCommand) utils.Response {
...
func PauseAlert(c *models.ReqContext, dto dtos.PauseAlertCommand) utils.Response {
...
func PauseAllAlerts(c *models.ReqContext, dto dtos.PauseAllAlertsCommand) utils.Response {
