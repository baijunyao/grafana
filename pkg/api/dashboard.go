...
func dashboardGuardianResponse(err error) utils.Response {
	if err != nil {
...
func (hs *HTTPServer) GetDashboard(c *models.ReqContext) utils.Response {
	slug := c.Params(":slug")
	uid := c.Params(":uid")
	...
	if hs.Cfg.IsPanelLibraryEnabled() {
		// load library panels
		err = hs.loadLibraryPanels(dash)
		if err != nil {
			return utils.Error(500, "Error while loading library panels", err)
		}
	}
...
func getDashboardHelper(orgID int64, slug string, id int64, uid string) (*models.Dashboard, utils.Response) {
...
func DeleteDashboardBySlug(c *models.ReqContext) utils.Response {
...
func DeleteDashboardByUID(c *models.ReqContext) utils.Response {
	return deleteDashboard(c)
}

func deleteDashboard(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) PostDashboard(c *models.ReqContext, cmd models.SaveDashboardCommand) utils.Response {
	cmd.OrgId = c.OrgId
	cmd.UserId = c.UserId
...
func dashboardSaveErrorToApiResponse(err error) utils.Response {
	var dashboardErr models.DashboardErr
	if ok := errors.As(err, &dashboardErr); ok {
...
func (hs *HTTPServer) GetHomeDashboard(c *models.ReqContext) utils.Response {
...
func GetDashboardVersions(c *models.ReqContext) utils.Response {
...
func GetDashboardVersion(c *models.ReqContext) utils.Response {
	dashID := c.ParamsInt64(":dashboardId")
...
func CalculateDashboardDiff(c *models.ReqContext, apiOptions dtos.CalculateDiffOptions) utils.Response {
...
func (hs *HTTPServer) RestoreDashboardVersion(c *models.ReqContext, apiCmd dtos.RestoreDashboardVersionCommand) utils.Response {
