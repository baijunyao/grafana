...
func GetSignedInUser(c *models.ReqContext) utils.Response {
	return getUserUserProfile(c.UserId)
}

// GET /api/users/:id
func GetUserByID(c *models.ReqContext) utils.Response {
	return getUserUserProfile(c.ParamsInt64(":id"))
}

func getUserUserProfile(userID int64) utils.Response {
...
func GetUserByLoginOrEmail(c *models.ReqContext) utils.Response {
...
// POST /api/user
func UpdateSignedInUser(c *models.ReqContext, cmd models.UpdateUserCommand) utils.Response {
...
// POST /api/users/:id
func UpdateUser(c *models.ReqContext, cmd models.UpdateUserCommand) utils.Response {
	cmd.UserId = c.ParamsInt64(":id")
	return handleUpdateUser(cmd)
}

// POST /api/users/:id/using/:orgId
func UpdateUserActiveOrg(c *models.ReqContext) utils.Response {
...
func handleUpdateUser(cmd models.UpdateUserCommand) utils.Response {
	if len(cmd.Login) == 0 {
		cmd.Login = cmd.Email
		if len(cmd.Login) == 0 {
...
// GET /api/user/orgs
func GetSignedInUserOrgList(c *models.ReqContext) utils.Response {
	return getUserOrgList(c.UserId)
}

// GET /api/user/teams
func GetSignedInUserTeamList(c *models.ReqContext) utils.Response {
	return getUserTeamList(c.OrgId, c.UserId)
}

// GET /api/users/:id/teams
func GetUserTeams(c *models.ReqContext) utils.Response {
	return getUserTeamList(c.OrgId, c.ParamsInt64(":id"))
}

func getUserTeamList(orgID int64, userID int64) utils.Response {
...
func GetUserOrgList(c *models.ReqContext) utils.Response {
	return getUserOrgList(c.ParamsInt64(":id"))
}

func getUserOrgList(userID int64) utils.Response {
...
func UserSetUsingOrg(c *models.ReqContext) utils.Response {
...
func ChangeUserPassword(c *models.ReqContext, cmd models.ChangeUserPasswordCommand) utils.Response {
...
// GET /api/users
func SearchUsers(c *models.ReqContext) utils.Response {
...
func SearchUsersWithPaging(c *models.ReqContext) utils.Response {
	query, err := searchUser(c)
	if err != nil {
		return utils.Error(500, "Failed to fetch users", err)
	}
...
func SetHelpFlag(c *models.ReqContext) utils.Response {
...
func ClearHelpFlags(c *models.ReqContext) utils.Response {
	cmd := models.SetUserHelpFlagCommand{
		UserId:     c.UserId,
