...
func GetDashboardSnapshot(c *models.ReqContext) utils.Response {
	key := c.Params(":key")
...
func DeleteDashboardSnapshotByDeleteKey(c *models.ReqContext) utils.Response {
...
func DeleteDashboardSnapshot(c *models.ReqContext) utils.Response {
	key := c.Params(":key")
...
func SearchDashboardSnapshots(c *models.ReqContext) utils.Response {
	query := c.Query("query")
