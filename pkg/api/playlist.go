...
func SearchPlaylists(c *models.ReqContext) utils.Response {
	query := c.Query("query")
...
func GetPlaylist(c *models.ReqContext) utils.Response {
	id := c.ParamsInt64(":id")
...
func GetPlaylistItems(c *models.ReqContext) utils.Response {
	id := c.ParamsInt64(":id")
...
func GetPlaylistDashboards(c *models.ReqContext) utils.Response {
...
func DeletePlaylist(c *models.ReqContext) utils.Response {
	id := c.ParamsInt64(":id")
...
func CreatePlaylist(c *models.ReqContext, cmd models.CreatePlaylistCommand) utils.Response {
	cmd.OrgId = c.OrgId
...
func UpdatePlaylist(c *models.ReqContext, cmd models.UpdatePlaylistCommand) utils.Response {
	cmd.OrgId = c.OrgId
