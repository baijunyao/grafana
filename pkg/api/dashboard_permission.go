...
func (hs *HTTPServer) GetDashboardPermissionList(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) UpdateDashboardPermissions(c *models.ReqContext, apiCmd dtos.UpdateDashboardAclCommand) utils.Response {
