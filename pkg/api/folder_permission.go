...
func (hs *HTTPServer) GetFolderPermissionList(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) UpdateFolderPermissions(c *models.ReqContext, apiCmd dtos.UpdateDashboardAclCommand) utils.Response {
