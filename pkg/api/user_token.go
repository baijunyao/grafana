...
func (hs *HTTPServer) GetUserAuthTokens(c *models.ReqContext) utils.Response {
	return hs.getUserAuthTokensInternal(c, c.UserId)
}

// POST /api/user/revoke-auth-token
func (hs *HTTPServer) RevokeUserAuthToken(c *models.ReqContext, cmd models.RevokeAuthTokenCmd) utils.Response {
	return hs.revokeUserAuthTokenInternal(c, c.UserId, cmd)
}

func (hs *HTTPServer) logoutUserFromAllDevicesInternal(ctx context.Context, userID int64) utils.Response {
...
func (hs *HTTPServer) getUserAuthTokensInternal(c *models.ReqContext, userID int64) utils.Response {
	userQuery := models.GetUserByIdQuery{Id: userID}
...
func (hs *HTTPServer) revokeUserAuthTokenInternal(c *models.ReqContext, userID int64, cmd models.RevokeAuthTokenCmd) utils.Response {
	userQuery := models.GetUserByIdQuery{Id: userID}
