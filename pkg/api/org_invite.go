...
func GetPendingOrgInvites(c *models.ReqContext) utils.Response {
...
func AddOrgInvite(c *models.ReqContext, inviteDto dtos.AddInviteForm) utils.Response {
...
func inviteExistingUserToOrg(c *models.ReqContext, user *models.User, inviteDto *dtos.AddInviteForm) utils.Response {
...
func RevokeInvite(c *models.ReqContext) utils.Response {
...
func GetInviteInfoByCode(c *models.ReqContext) utils.Response {
...
func (hs *HTTPServer) CompleteInvite(c *models.ReqContext, completeInvite dtos.CompleteInviteForm) utils.Response {
...
func updateTempUserStatus(code string, status models.TempUserStatus) (bool, utils.Response) {
...
func applyUserInvite(user *models.User, invite *models.TempUserDTO, setActive bool) (bool, utils.Response) {
	// add to org
