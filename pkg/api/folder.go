...
func GetFolders(c *models.ReqContext) utils.Response {
...
func GetFolderByUID(c *models.ReqContext) utils.Response {
	s := dashboards.NewFolderService(c.OrgId, c.SignedInUser)
...
func GetFolderByID(c *models.ReqContext) utils.Response {
	s := dashboards.NewFolderService(c.OrgId, c.SignedInUser)
...
func (hs *HTTPServer) CreateFolder(c *models.ReqContext, cmd models.CreateFolderCommand) utils.Response {
	s := dashboards.NewFolderService(c.OrgId, c.SignedInUser)
...
func UpdateFolder(c *models.ReqContext, cmd models.UpdateFolderCommand) utils.Response {
	s := dashboards.NewFolderService(c.OrgId, c.SignedInUser)
...
func DeleteFolder(c *models.ReqContext) utils.Response {
	s := dashboards.NewFolderService(c.OrgId, c.SignedInUser)
...
func toFolderError(err error) utils.Response {
